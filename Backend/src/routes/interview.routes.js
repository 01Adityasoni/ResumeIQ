 ...
 * @description delete an interview report (only owner)
 * @access Private
 */
interviewRoutes.delete('/:interviewId', authMiddleware.authUser, interviewController.deleteInterviewReportController)
